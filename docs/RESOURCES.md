...
## 🤖 Agent Frameworks
- [AutoGen Tutorial](https://www.youtube.com/watch?app=desktop&v=nMniwlGyX-c)
...
- [AI Research Assistant GitHub](https://github.com/paradoxtown/AI-Research-Assistant/tree/main)
- [Anthropic Real World Prompting Course](https://github.com/anthropics/courses/blob/master/real_world_prompting/README.md)
- [Anthropic Prompt Evaluations Course](https://github.com/anthropics/courses/blob/master/prompt_evaluations/README.md)

## 🌐 LangGraph Resources
- [LangGraph Examples](https://github.com/langchain-ai/langgraph-example)
- [Graph Websearch Agent](https://github.com/john-adeojo/graph_websearch_agent)
- [LangGraph Studio](https://github.com/langchain-ai/langgraph-studio)

## 📚 Additional Reading
- [AI Agents Directory](https://aiagentsdirectory.com/landscape)
- [Why Multi-Agent AI Systems are the Future](https://dev.to/istiquritconsultant/why-a-multi-agent-ai-system-is-the-future-of-workflow-automation-2752)